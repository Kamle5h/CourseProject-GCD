The run_analysis.R script executes as below
downloads required data from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
unzips the file if it has not been uncompressed
creates results folder if it does not exist (results are stored in this folder)
...
The file mean_and_std.csv is in the results folder
...
The file tidy_dataset.csv is in the results folder
